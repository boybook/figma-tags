<template>
  <span class="tag" :style="{ padding: removable ? '0 0 0 8px' : '0 8px', backgroundColor: 'rgba(' + tag.color.r + ',' + tag.color.g + ',' + tag.color.b + ',' + tag.color.a + ')' }">
    {{ tag.name }}
